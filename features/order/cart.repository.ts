...
import { OrderItemAdd, OrderItemRemove, OrderItemUpdate } from "./order.schema";
...
export interface ICartRepository {
  ...
  addItem: (userId: string, payload: OrderItemAdd) => Promise<void>;
  removeItem: (userId: string, payload: OrderItemRemove) => Promise<void>;
  updateItem: (userId: string, payload: OrderItemUpdate) => Promise<void>;
...
class CartRepository implements ICartRepository {
  ...
  async addItem(userId: string, payload: OrderItemAdd) {
  ...
  async removeItem(userId: string, payload: OrderItemRemove) {
  ...
  async updateItem(userId: string, payload: OrderItemUpdate) {
  ...
  //   try {
  //     const response = await axios.get<{ data: number }>(url);
