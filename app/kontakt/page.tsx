...
export default function Contactpage() {
  return (
    <>
      <section className="relative py-20 2xl:py-40 bg-background">
        <img
          className="hidden lg:block absolute opacity-50 top-0 left-0 w-2/5"
          src="/assets/content/map_pin.webp"
          alt="map"
        />
        ...
        <div className="relative container px-4 mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="mt-10 text-5xl font-light font-heading text-black">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-wrap -mx-4 mb-20">
              <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
                <div className="bg-white rounded-b-lg">
                  <img
                    ...
                    src="/assets/content/utsiden_kveld.webp"
                    alt="contact"
                  />
                  <div className="px-4 md:px-14 py-8">
                    <div className="mb-6 py-px bg-gray-500" />
                    <h3 className="mb-8 lg:mb-4 text-xl text-black font-bold">
                      Har du spørsmål? Send oss en melding!
                    </h3>
                    <div className="md:text-right">
                      <a
                        className="inline-block px-12 py-4 border border-gray-300 hover:border-gray-200 rounded-full font-bold text-white bg-primary"
                        href="#"
                      >
                        Melding
                      </a>
              ...
              <div className="w-full lg:w-1/2 px-4">
                <div className="py-6 px-4 md:px-8 mb-4 bg-white rounded-lg group hover:bg-secondary transition duration-200">
                  <a
                    href="tel:99045455"
                    target="_blank"
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base md:text-lg font-bold text-black group-hover:text-white transition duration-200">
                      +47 99 04 54 55
                    </p>
                  </a>
                </div>
                <div className="py-6 px-4 md:px-8 mb-10 bg-white hover:bg-secondary group rounded-lg transition duration-200">
                  <a
                    href="mailto:tv@salongpartner.no"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center"
                  >
                ...
                <div className="py-6 px-4 md:px-8">
                  <div className="flex">
                    <span className="flex-shrink-0 flex items-center justify-center w-12 h-12 mr-8 bg-primary rounded-lg">
                      <svg
                        className="w-5 h-5"
                        width={23}
                        height={23}
            ...
            <div className="text-center">
              <p className="mb-4 text-xl text-gray-600">
                Ser du etter materiell og guider?
              </p>
              <Link
                className="inline-flex text-primary hover:text-primary/75 font-bold"
                href="/materiell"
              >
