...
export async function generateMetadata({
  ...
  if (params.pageType === 'merke') {
    const defaultMeta = {
      title: "Merke",
      description: 'Oppdag vår merkevare som står for kvalitet, innovasjon og pålitelighet. Vi leverer produkter og tjenester som setter kunden i fokus.',
    };
    return {
      ...defaultMeta,
    };
...
const Page = async ({
  ...
  return (
    <>
      <ProductPage params={params} cartItems={cartItem} customerGroup={customerGroup} />
    </>
  );
};
