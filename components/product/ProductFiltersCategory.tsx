...
export default function ProductFiltersCategory({
  ...
  const handleRemoveFilter = (filter: string) => {
    ...
    const updatedSkinTypeFilters = skinTypeFilters.filter((item) => item !== filter);
    setSkinTypeFilters(updatedSkinTypeFilters);
    onSkinTypeFilterChange(updatedSkinTypeFilters);
    ...
    <div className="container px-4 mx-auto w-full pt-10">
      <div className="pb-9 text-center border-b border-black border-opacity-5">
        <div className="relative">
          <h2 className="text-4xl xl:text-5xl text-center text-black font-light leading-normal font-heading mt-3 mb-5 md:mb-0 capitalize">
            {categoryName}
          </h2>
          <span className="md:absolute md:right-0 md:bottom-3 text-sm text-gray-400 font-base">
